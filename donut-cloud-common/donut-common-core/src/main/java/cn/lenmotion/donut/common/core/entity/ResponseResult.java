...
public class ResponseResult<T> implements Serializable {
    ...
    public static <T> ResponseResult<T> unLogin() {
        return custom(ResponseCodeEnum.UN_LOGIN.getCode(), null, null);
    }

    public static <T> ResponseResult<T> unLogin(String message) {
        return custom(ResponseCodeEnum.UN_LOGIN.getCode(), message, null);
    }
