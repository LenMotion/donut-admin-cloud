package cn.lenmotion.donut.common.excel;
...
import cn.lenmotion.donut.system.client.SysExportLogFeignClient;
...
public class ExcelClient {
    ...
    private final SysExportLogFeignClient exportLogFeignClient;
    ...
    public <T> String export(List<T> list, Class<T> clz, SysExportLog exportLog, TimeInterval timer) {
        ...
        try {
            ...
            exportLogFeignClient.endExport(exportLog);
            IoUtil.close(out);
        }
    }
