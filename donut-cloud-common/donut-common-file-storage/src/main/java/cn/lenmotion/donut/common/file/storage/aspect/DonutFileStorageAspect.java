package cn.lenmotion.donut.common.file.storage.aspect;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.StrUtil;
import cn.lenmotion.donut.common.core.exception.BusinessException;
import cn.lenmotion.donut.common.file.storage.config.FileExtProperties;
...
public class DonutFileStorageAspect implements FileStorageAspect {
    ...
    private final FileExtProperties fileExtProperties;
    ...
    public FileInfo uploadAround(UploadAspectChain chain, FileInfo fileInfo, UploadPretreatment pre, FileStorage fileStorage, FileRecorder fileRecorder) {
        ...
        if (!CollUtil.contains(fileExtProperties.getFileExt(), fileInfo.getExt().toLowerCase(Locale.ROOT))) {
