...
import cn.lenmotion.donut.auth.config.ProjectProperties;
import cn.lenmotion.donut.auth.entity.CaptchaVo;
import cn.lenmotion.donut.common.redis.template.JacksonRedisTemplate;
import cn.lenmotion.donut.common.core.annotation.RateLimiter;
...
public class CaptchaController {
    ...
    public ResponseResult<CaptchaVo> getCode() {
        ...
        // 判断是否开启验证码登陆
        Boolean captchaOnOff = configFeignClient.getConfigBoolValue(ConfigConstants.CAPTCHA_ON_OFF);
