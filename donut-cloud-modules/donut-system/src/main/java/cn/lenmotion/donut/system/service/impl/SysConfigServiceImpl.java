...
import cn.lenmotion.donut.common.core.utils.AopUtils;
...
public class SysConfigServiceImpl extends DonutServiceImpl<SysConfigMapper, SysConfig> implements SysConfigService {
    ...
    @Override
//    @Cacheable(value = RedisConstants.CONFIG_KEY, key = "#cn.lenmotion.donut.common.core.context.TenantContext.getTenant() + ':' + #configKey")
